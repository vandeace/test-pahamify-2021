...
const Login = (props) => {
  ...
  const toggle = () => {
    props.setModalLogin(!props.setModalLogin);
  };
  console.log(errors, "errors");
  console.log(props.modalLogin, "props.modalLogin");
  return (
    <div>
      <Modal
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            <div className="flex flex-col">
              <input
                ...
                placeholder="Email"
                name="email"
                className="w-full border-gray-light border my-2 p-2 rounded-3xl focus:outline-none shadow appearance-none "
